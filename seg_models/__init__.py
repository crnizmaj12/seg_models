...
def framework():
    """Return name of Seg-Models framework"""
    return _KERAS_FRAMEWORK


def set_framework(name):
    """Set framework for Seg-Models
...
print('Seg-Models: using `{}` framework.'.format(_KERAS_FRAMEWORK))
...
# wrap Seg-Models with framework modules
